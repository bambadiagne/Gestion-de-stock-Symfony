    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
          ->add('client',EntityType::class,array('class' => Client::class,'choice_label' => 'libelle' ))
            ...
            ->add('base1',TextType::class, array('label' => 'Base 1 : '))
            ->add('tva1', TextType::class, array('label' => 'Tva 1 : '))
            ->add('base2', TextType::class, array('label' => 'Base 2 : '))
            ->add('tva2', TextType::class, array('label' => 'Tva 2 : '))
            ->add('base3', TextType::class, array('label' => 'Base 3 : '))
            ->add('tva3', TextType::class, array('label' => 'Tva 3 : '))
